    ...
    <div class="content-3-5 d-flex flex-column align-items-center h-100 flex-lg-row"
      ...
      <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
        <div class="right mx-lg-0 mx-auto">
          ...
          <form method="POST" style="margin-top: 1.5rem" action="{{ route('welcome') }}">
            @csrf
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0 @error('email')
                    is-invalid
                @enderror" type="email" name="email" id="email" placeholder="Your Email Address"
            ...
            <div style="margin-top: 1rem">
              ...
              <div class="d-flex w-100 div-input">
                ...
                <input class="input-field border-0" type="password" name="password" id="password"
                  placeholder="Your Password" minlength="6" autofocus required />
